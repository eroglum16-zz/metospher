<div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <!-- <li style="float: right;"><a href="index.html"> <span class="fa fa-plus"></span> Yeni Post</a></li> -->
        </ul>
        <!-- BEGIN SIDEBAR & CONTENT -->
        <div class="row margin-bottom-40">
          <!-- BEGIN CONTENT -->
          <div class="col-md-12 col-sm-12">
            <h1><a href="index.html"> <span class="fa fa-plus"></span> Yeni Post Ekleyin</a></h1>
